...
const DeliveryBoy = () => {
  ...
  const getAssignments = async () => {
    try {
      ...
      console.log("getAssignments", result.data);
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      setLoading(false)
      setShowOtpBox(true);
      console.log("sendOtp", result.data);
    } catch (error) {
  ...
  const handleTodayDeliveries = async () => {
    try {
      ...
      console.log("handleTodayDeliveries", result.data);
      setTodayDeliveries(result.data);
    } catch (error) {
      console.log("handleTodayDeliveries", error);
    }
  };
  ...
  return (
    <div className="w-screen min-h-screen flex flex-col gap-5 items-center bg-[#fff9f6] overflow-y-auto">
      ...
      <div className="w-full max-w-[800px] flex flex-col gap-5 items-center">
        <div className="bg-white rounded-2xl shadow-md p-5 flex justify-start flex-col items-center w-[90%] border border-orange-100 text-center gap-2">
