...
const TrackOrderPage = () => {
  ...
  // const {socket} = useSelector(state=>state.user) // Removed Redux socket
  ...
  const handleGetOrder = async () => {
    try {
      ...
      console.log("handleGetOrder", result.data);
    } catch (error) {
      console.log("handleGetOrder", error);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 flex flex-col gap-6">
      <div
        className="relative flex items-center gap-4 cursor-pointer top-[20px] left-[20px] z-[10] mb-[10px]"
